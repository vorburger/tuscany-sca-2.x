...
public class BioTestCase {
    ...
    public static void main(String[] args) {
        ...
        Node node = factory.createNode("resources/clinicalLaboratory.composite", new Contribution("clinical", contribution)).start();
		
		        BiochemicalCircle biochemicalCircle = ((Client)node).getService(BiochemicalCircle.class, "BiochemicalCircleComponent");
