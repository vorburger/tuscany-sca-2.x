...
public class HelloWorldClient {
    ...
    public final static void main(String[] args) throws Exception {
       ...
       Node node = factory.createNode("helloworldwsclient.composite", new Contribution("helloworld", contribution)).start();
        

        HelloWorldService helloWorldService = ((Client)node).getService(HelloWorldService.class, "HelloWorldServiceComponent");
